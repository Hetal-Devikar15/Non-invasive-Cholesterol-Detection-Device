...
public class Popup extends PopupWindow {
    ...
    public Popup(Context context, boolean success, String msg) {
        ...
        ImageView icon = contentView.findViewById(R.id.popup_icon);
        TextView popupMsg = contentView.findViewById(R.id.popup_msg);
        if(success) {
        ...
        onBtn = contentView.findViewById(R.id.popup_ok);
